...
<div class="note">
    <?php echo JText::_("PLG_K2STORE_PAYMENTS_ZARINPALWG_DISPLAY_NAME"); ?>
    <br/>
    <br/>
    <?php echo JText::_("PLG_K2STORE_PAYMENTS_ZARINPALWG_PREPARE_MESSAGE"); ?>
</div>
<br/>
<div class="note">
    <?php if (!isset($vars->error)) { ?>
        <form action="<?php echo $vars->redirectToZP ?>" method="get">
            <input type="submit" class="btn btn-primary button"
                   value="<?php echo JText::_("PLG_K2STORE_PAYMENTS_ZARINPALWG_PAY"); ?>"/>
        </form>
    <?php } else { ?>
